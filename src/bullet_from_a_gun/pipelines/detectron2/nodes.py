...
==============================
+ 06_models/tuned
    + {_experiment_id_}.json, contains fine-tuning metadata and model architecture details
+ 06_models/output
    + {_experiment_id_}/, contains training logs
+ 06_models/eval
    + {_experiment_id_}.json, contains evaluation metadata

Report
==============================
+ 08_reporting/{_experiment_id_}/, contains samples of predictions
+ 08_reporting/plots/{_experiment_id_}/, contains plots of confusion matrices generated by supervision library
        """
